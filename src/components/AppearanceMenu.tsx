...
export default function AppearanceMenu({ isOpen, onClose }: AppearanceMenuProps) {
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="absolute right-4 top-4 w-72 max-h-[calc(100vh-200px)] overflow-y-auto z-50"
        >
